...
const demoHeader = {
    ...
    desc: '<code>reorderDragable</code> function is used for reordering items within or across droppable areas in a drag-and-drop interface, using the <code>DraggableLocation</code> structure.',
}
