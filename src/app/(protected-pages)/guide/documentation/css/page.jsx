    ...
    return (
        <>
            <p>
                ...
                depends on certain CSS processing features, we&apos;re using
                PostCSS as our preprocessor.
            </p>
...
`}
            ...
            <div className="mt-10" id="writingCss">
                <h5>Custom CSS</h5>
                <p className="mt-1">
                    If Tailwind doesn&apos;t cover all your styling needs, you
                    can add custom CSS in this folder. We recommend using
                    Tailwind&apos;s functions and directives when adding custom
                    styles, such as <code>@apply</code>, <code>@layer</code>,
                    and <code>theme()</code>.
                </p>
                <p>
